...
public class Indexer implements Serializable
{
    ...
    private final static long serialVersionUID = 2189845596478795490L;
    ...
    public Indexer withRate(String rate) {
        this.rate = rate;
        return this;
    }
    ...
    public Indexer withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Indexer) == false) {
            return false;
        }
        Indexer rhs = ((Indexer) other);
