...
public class Customers__ implements Serializable
{
    ...
    private final static long serialVersionUID = 1556430033579261708L;
    ...
    public Customers__ withRate(String rate) {
        this.rate = rate;
        return this;
    }
    ...
    public Customers__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Customers__) == false) {
            return false;
        }
        Customers__ rhs = ((Customers__) other);
